                    ...
                    with arcpy.da.SearchCursor(Via_ly , fields) as cursor:
                        for row in cursor:
                            ...
                            if(row[1] == 1 and row[4] <> '1'): 
                                file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if(row[1] == 2 and row[2] not in ['1','2']):
                                file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if(row[1] == 2 and row[3] <> '2'):
                                file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if(row[1] == 2 and row[4] <> '1'): 
                                file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if(row[1] == 3 and row[2] not in ['2','3']):
                                 file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if(row[1] == 3 and row[3] <> '0'): 
                                 file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if (row[1] == 3 and row[4] <> '2'):
                                file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if(row[1] == 4 and row[2] <> '4'): 
                                file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if(row[1] == 4 and row[3] <> '0'):
                                file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if (row[1] == 4 and row[4] <> '2'):
                                file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if(row[1] == 5 and row[2] <> '0'):
                                file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if(row[1] == 5 and row[3] <> '0'):
                                file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if (row[1] == 5 and row[4] <> '0'):
                                file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if (row[1] == 6 and row[2] <> '0'):
                                file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if (row[1] == 6 and row[3] <> '0'):
                                file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                            if (row[1] == 6 and row[4] <> '0'):
                                file.write("Via Tipo-RuleID," + " " + "ObjectID: " + " " +  str(row[0]) + " " + "\n")
                Via("Via_ly")
