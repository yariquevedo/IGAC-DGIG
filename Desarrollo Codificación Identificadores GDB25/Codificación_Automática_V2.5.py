...
F=""
reco=0
DATASET=["CoberturaTierra","CoberturaTierra","CoberturaTierra","Elevacion","Elevacion","Geodesia","Hidrografia","Hidrografia","Hidrografia","Hidrografia","Hidrografia","Hidrografia","Hidrografia","Hidrografia","Hidrografia","Hidrografia","InfraestructuraServicios","InfraestructuraServicios","InfraestructuraServicios","InfraestructuraServicios","InfraestructuraServicios","NombresGeograficos","OrdenamientoTerritorial","OrdenamientoTerritorial","OrdenamientoTerritorial","OrdenamientoTerritorial","Transporte","Transporte","Transporte","Transporte","Transporte","Transporte","Transporte","Transporte","Transporte","Transporte","ViviendaCiudadTerritorio","ViviendaCiudadTerritorio","ViviendaCiudadTerritorio","ViviendaCiudadTerritorio","ViviendaCiudadTerritorio","ViviendaCiudadTerritorio","ViviendaCiudadTerritorio","ViviendaCiudadTerritorio","ViviendaCiudadTerritorio","Elevacion","Elevacion"]
FEATURECLASS=["AExtra","Bosque","ZVerde","CNivel","LDTerr","MRTerr","BArena","DAgua_P","DAgua_R","Drenaj_L","LCoste","Humeda","Isla","Mangla","Drenaj_R","DAgua_L","PDistr","Pozo","RATens","TSPubl","Tuberi","NGeogr","Depart","LLimit","Fronte","MDANMu","LVia","Puente_L","SVial","Tunel","VFerre","Via","Ciclor","Puente_P","Telefe","Embarc","Cerca","Constr_P","Constr_R","Muro","Piscin","ZDura","LDemar","Terrap","BArena","CNivel","LDTerr"]
COD=["5002","5001","5003","6001","6002","1001","4005","4002","4002","4001","4006","4005","4004","4003","4001","4002","8002","8004","8001","8003","8005","9001","7002","7001","7004","7003","3005","3002","3006","3003","3004","3001","3007","3002","3008","3009","2002","2001","2001","2003","2005","2004","2006","2007","2008","6001","6002"]
NOM=["Áreas de Extracción","Bosque","Zona verde","Curva de nivel","Línea de demarcación de terreno","Marco de referencia terrestre","Banco de arena","Deposito de agua","Deposito de agua","Drenaje","Linea_Costera","Humedal","Isla","Manglar","Drenaje","Deposito de agua","Punto de distribucion","Pozo","Red de alta tension","Tapa de servicios públicos"," tuberia","Nombre geogrâ€¡fico","Departamento","Línea limítrofe","Frontera","Municipio distrito y area no municipalizada","Limite via","Puente","Separador vial","Tunel","Via ferrea","Via"," cicloruta","Puente"," teleferico","Embarcadero","Cerca","Construccion","Construccion","Muro","Piscina","Zona dura","Linea_Demarcacion"," terraplen","Banco_Arena","Curva_Nivel","Linea_Demarcacion_Terreno"]
IDEN=["AEIdentif","BIdentif","ZVIdentif","CNIdentif","LDTIdentif","MRTIdentif","BAIdentif","DAIdentif","DAIdentif","DIdentif","LCIdentif","HIdentif","IsIdentif","MgIdentif","DIdentif","DAIdentif","PDIdentif","PoIdentif","RATIdentif","TSPIdentif","TubIdentif","NGIdentif","DeCodigo","LLIdentif","FCodigo","MDANMCodig","LVIdentif","PIdentif","SVIdentif","TIdentif","VFIdentif","VIdentif","CiIdentif","PIdentif","TelIdentif","EIdentifi","CeIdentif","CIdentif","CIdentif","MuIdentif","PiIdentif","ZDIdentif","LDIdentif","TeIdentif","BAIdentif","CNIdentif","LDTIdentif"]
...
try:
    ...
    arcpy.AddWarning("Iniciando proceso codificación automatica V2.5, se creará el diccionario a partir de la siguiente tabla:")
    CSV_STR = pandas.DataFrame(dic)
