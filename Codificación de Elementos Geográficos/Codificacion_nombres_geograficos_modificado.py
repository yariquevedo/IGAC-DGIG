#Semillero de Innovación y Desarrollo
#Yaritza Quevedo
...
Numero_codigo = arcpy.GetParameterAsText(2)
                ...
                for municipios in poligonos:
                    if(municipios[0].contains(elementos[0], 'BOUNDARY')== True): 
                        if (len(str(elementos[2])) == 1 and (len(str(elementos[3])) == 1)): #En python los formatos tipo texto si se permite contar los digitos como el cursor elementos el indice 3 son tipo número en la tabla de atributos de ArcGIS se debe pasar a texto
                            if (len(str(i)) ==1):
                                elementos[1] = municipios[1] + "0" + str(elementos[2])+ "0"+ str(elementos[3]) + "000000"+ str(i)
                            elif (len(str(i)) ==2):
                            ...
                            if (len(str(i)) ==1):
                                elementos[1] = municipios[1] + str(elementos[2])+ "0"+ str(elementos[3]) + "000000"+ str(i)
                            elif (len(str(i)) ==2):
                            ...
                            if (len(str(i)) ==1):
                                elementos[1] = municipios[1] + "0" + str(elementos[2])+ str(elementos[3]) + "000000"+ str(i)
                            elif (len(str(i)) ==2):
                            ...
                            if (len(str(i)) ==1):
                                elementos[1] = municipios[1] + str(elementos[2])+ str(elementos[3]) + "000000"+ str(i)
                            elif (len(str(i)) ==2):
